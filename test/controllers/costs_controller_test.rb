...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { name: @cost.name, price: @cost.price, quantity: @cost.quantity, report_id: @cost.report_id, totla: @cost.totla }
    end
  ...
  test "should update cost" do
    patch :update, id: @cost, cost: { name: @cost.name, price: @cost.price, quantity: @cost.quantity, report_id: @cost.report_id, totla: @cost.totla }
    assert_redirected_to cost_path(assigns(:cost))
  end
