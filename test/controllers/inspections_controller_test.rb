...
class InspectionsControllerTest < ActionController::TestCase
  ...
  test "should create inspection" do
    assert_difference('Inspection.count') do
      post :create, inspection: { comment: @inspection.comment, finish: @inspection.finish, keep_goin: @inspection.keep_goin, title: @inspection.title }
    end
  ...
  test "should update inspection" do
    patch :update, id: @inspection, inspection: { comment: @inspection.comment, finish: @inspection.finish, keep_goin: @inspection.keep_goin, title: @inspection.title }
    assert_redirected_to inspection_path(assigns(:inspection))
  end
